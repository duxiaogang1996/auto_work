...
async function generateOfferSql() {
    const data = {
        ...
        TELE_TYPE: document.getElementById('offer_TELE_TYPE').value,
        ...
        PRODUCT_TYPE: document.getElementById('offer_PRODUCT_TYPE').value,
        PROD_SUB_TYPE: document.getElementById('offer_PROD_SUB_TYPE').value,

        PROD_PRICE_TYPE: document.getElementById('offer_PROD_PRICE_TYPE').value,
        PROD_LEVEL: document.getElementById('offer_PROD_LEVEL').value,
...
window.togglePresentSection = togglePresentSection;
window.offerCopySql = offerCopySql;
window.offerCopySqlToDbExecute = offerCopySqlToDbExecute;
window.generateOfferSql = generateOfferSql;
