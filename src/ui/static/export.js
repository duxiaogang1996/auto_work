...
export function saveResultToFile() {
    ...
    addLog("保存结果成功：" + fileName);
}

export function exportCancelAccountXLS() {
    const table = document.getElementById("resultTable");
    if (!table) return;
...
window.saveResultToFile = saveResultToFile;
window.exportCancelAccountXLS = exportCancelAccountXLS;
